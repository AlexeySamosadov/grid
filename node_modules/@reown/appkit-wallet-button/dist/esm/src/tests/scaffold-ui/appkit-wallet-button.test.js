...
import { ChainController, ConnectorController, CoreHelperUtil, ModalController, RouterController } from '@reown/appkit-controllers';
...
describe('AppKitWalletButton', () => {
    ...
    test('should connect with social', async () => {
        const element = await fixture(html `<appkit-wallet-button wallet="google"></appkit-wallet-button>`);
    ...
    test('should connect with walletConnect', async () => {
        ...
        const element = await fixture(html `<appkit-wallet-button wallet="metamask"></appkit-wallet-button>`);
    ...
    test('should redirect to all wallets on mobile if walletConnect is selected', async () => {
        ...
        const RouterControllerReplaceSpy = vi.spyOn(RouterController, 'replace');
        const element = await fixture(html `<appkit-wallet-button wallet="walletConnect"></appkit-wallet-button>`);
        const walletButton = HelpersUtil.getByTestId(element, WALLET_BUTTON);
        const walletButtonClick = vi.fn();
        walletButton.addEventListener('click', walletButtonClick);
        await walletButton.click();
    ...
    test('should connect with external connector', async () => {
        ...
        vi.spyOn(ConnectorControllerUtil, 'connectExternal').mockRejectedValueOnce('Connection rejected');
        const walletButtonExternalClick = vi.fn();
...
//# sourceMappingURL=appkit-wallet-button.test.js.map