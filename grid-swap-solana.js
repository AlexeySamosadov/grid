...
async function main(){
    ...
    async function trySwap(){
        ...
        try{
            /* ── шаг 0: узнаём актуальную цену (quote на 0.001 SOL) ── */
            ...
            if(perGridLamports>0n){
                /* ── BUY quote/price с новым объёмом ── */
    ...
    /* helper – выполнить swap Jupiter Lite */
